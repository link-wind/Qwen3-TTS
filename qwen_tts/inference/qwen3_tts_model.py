...
from ..core.models import (ControlTokenPreprocessor, Qwen3TTSConfig,
...
class Qwen3TTSModel:
    ...
    def __init__(self, model: Qwen3TTSForConditionalGeneration, processor, generate_defaults: Optional[Dict[str, Any]] = None):
        ...
        self.control_preprocessor = ControlTokenPreprocessor()
    ...
    def _build_controlled_payload_texts(
        ...
        return self.control_preprocessor.build_payload_texts(
            texts=texts,
            emotion=emotion,
            intensity=intensity,
            emphasis=emphasis,
